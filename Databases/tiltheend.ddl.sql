...
(
  POST_NO_ANNO VARCHAR(100) NOT NULL COMMENT '번호',
...
(
  ...
  FILE_ORDER        INTEGER      NULL     COMMENT '등록순서',
...
(
  ...
  REQUIREMENT      VARCHAR(100) NULL     COMMENT '요구사항',
  PRIMARY KEY (DELIVERY_ID)
) COMMENT '배송정보';

CREATE TABLE FAQ
(
  POST_NO_FAQ VARCHAR(100) NOT NULL,
  UID         VARCHAR(100) NOT NULL COMMENT '유저ID',
...
CREATE TABLE QNA
(
  POST_NO_QNA VARCHAR(100) NOT NULL,
  UID         VARCHAR(100) NOT NULL COMMENT '유저ID',
  CATEGORY    VARCHAR(200) NOT NULL,
  TITLE       VARCHAR(200) NOT NULL,
  DATE        VARCHAR(200) NOT NULL,
  CONTENT     VARCHAR(200) NOT NULL,
  STATUS      VARCHAR(200) NOT NULL COMMENT '답변 유무',
...
(
  ...
  UID            VARCHAR(100) NOT NULL COMMENT '유저ID',
  PRODUCT_ID     VARCHAR(100) NOT NULL COMMENT '상품아이디',
  RATE           VARCHAR(100) NOT NULL COMMENT '별점',
  REVIEW_CONTENT VARCHAR(100) NOT NULL COMMENT '리뷰 내용',
  DATE           VARCHAR(100) NOT NULL COMMENT '입력 날짜',
