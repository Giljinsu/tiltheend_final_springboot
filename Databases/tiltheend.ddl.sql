...
(
  ...
  THUMBNAIL_NAME    varchar(500) NULL     COMMENT '썸네일 첨부파일명',
  ATTACHFILE_PATH   varchar(500) NULL     COMMENT '첨부파일 저장경로',
  ATTACHFILE_SIZE   decimal      NULL     COMMENT '첨부파일 크기',
  ATTACHFILE_HEIGHT decimal      NULL     COMMENT '파일 높이',
  ATTACHFILE_WIDTH  decimal      NULL     COMMENT '파일 폭',
