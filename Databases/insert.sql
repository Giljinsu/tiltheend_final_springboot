...
INSERT INTO CIP_ATTACHFILE
        ...
        REGISTER_SEQ, REGISTRY_DATE, MODIFIER_SEQ, MODIFY_DATE)
VALUES
		('UU142', 'CORD_1', 'model1_2.jpg','dami','REG1123',SYSDATE(),'MOD1122',SYSDATE())
;
INSERT INTO CIP_ATTACHFILE
        (ATTACHFILE_SEQ, SOURCE_UNIQUE_SEQ, ORGINALFILE_NAME, PHYSICALFILE_NAME, 
        REGISTER_SEQ, REGISTRY_DATE, MODIFIER_SEQ, MODIFY_DATE)
VALUES
		('UU152', 'CORD_1', 'model1_3.jpg','dami','REG1123',SYSDATE(),'MOD1122',SYSDATE())
;
INSERT INTO CIP_ATTACHFILE
        (ATTACHFILE_SEQ, SOURCE_UNIQUE_SEQ, ORGINALFILE_NAME, PHYSICALFILE_NAME, 
        REGISTER_SEQ, REGISTRY_DATE, MODIFIER_SEQ, MODIFY_DATE)
VALUES
		('UU162', 'CORD_1', 'model1_4.jpg','dami','REG1123',SYSDATE(),'MOD1122',SYSDATE())
;
...
(ORDER_ID,PRODUCT_ID,UID,DELIVERY_ID,ORDER_METHOD,FINAL_PRICE,ORDERDATE,ADDITIONAL_DISCOUNT)
VALUES
('ORDER_01','PROD_1','U0001','DEL_1','카드','54,000',SYSDATE(),'25');
INSERT INTO ORDERLIST
(ORDER_ID,PRODUCT_ID,UID,DELIVERY_ID,ORDER_METHOD,FINAL_PRICE,ORDERDATE,ADDITIONAL_DISCOUNT)
VALUES
('ORDER_02','PROD_2','U0001','DEL_2','카드','75,000',SYSDATE(),'30');
INSERT INTO ORDERLIST
(ORDER_ID,PRODUCT_ID,UID,DELIVERY_ID,ORDER_METHOD,FINAL_PRICE,ORDERDATE,ADDITIONAL_DISCOUNT)
VALUES
('ORDER_03','PROD_3','U0001','DEL_3','무통장입금','134,000',SYSDATE(),'20');
