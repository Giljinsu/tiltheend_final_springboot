...
CREATE TABLE COORDINATION_PICTURE
(
  ATTACHFILE_SEQ  varchar(40)  NOT NULL COMMENT '첨부파일 일련번호',
  COORDINATION_ID VARCHAR(100) NOT NULL COMMENT '코디게시글ID'
) COMMENT '코디 사진들';
...
ALTER TABLE COORDINATION_PICTURE
  ADD CONSTRAINT FK_CIP_ATTACHFILE_TO_COORDINATION_PICTURE
    FOREIGN KEY (ATTACHFILE_SEQ)
    REFERENCES CIP_ATTACHFILE (ATTACHFILE_SEQ);

ALTER TABLE COORDINATION_PICTURE
  ADD CONSTRAINT FK_COORDINATION_INFO_TO_COORDINATION_PICTURE
    FOREIGN KEY (COORDINATION_ID)
    REFERENCES COORDINATION_INFO (COORDINATION_ID);

ALTER TABLE REVIEW_PICTURE
  ADD CONSTRAINT FK_CIP_ATTACHFILE_TO_REVIEW_PICTURE
    FOREIGN KEY (ATTACHFILE_SEQ)
    REFERENCES CIP_ATTACHFILE (ATTACHFILE_SEQ);

ALTER TABLE REVIEW_PICTURE
  ADD CONSTRAINT FK_REVIEW_TO_REVIEW_PICTURE
